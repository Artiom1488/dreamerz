export interface PhoneCountry {
  ...
  iso2: string;
  /** E.164 calling code, e.g. "+373". */
  dialCode: string;
}

// Sorted alphabetically by name for a predictable default browsing order.
// If a territory is missing, just add a row — no other code needs to change.
export const PHONE_COUNTRIES: PhoneCountry[] = [
  ...
  { name: "US Virgin Islands", iso2: "VI", dialCode: "+1340" },
